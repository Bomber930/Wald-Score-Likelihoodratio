...
| --- | --- | --- | --- | --- |
| lr | 0.025 | 0.950 | 0.000 | 0.091 |
| score | 0.025 | 0.950 | 0.000 | 0.106 |
| wald | 0.025 | 0.950 | 0.000 | 0.137 |
...
| test_label | size | power_at_max_effect | failure_rate | mean_runtime_ms |
| --- | --- | --- | --- | --- |
| lr | 0.150 | 0.975 | 0.000 | 1.753 |
| score | 0.150 | 0.975 | 0.000 | 0.853 |
| wald | 0.150 | 0.975 | 0.000 | 1.081 |
...
| test_label | size | power_at_max_effect | failure_rate | mean_runtime_ms |
| --- | --- | --- | --- | --- |
| lr | 0.000 | 0.750 | 0.000 | 3.332 |
| lr_bootstrap | 0.000 | 0.850 | 0.000 | 127.988 |
| score | 0.125 | 0.750 | 0.000 | 0.138 |
| wald | 0.000 | 0.825 | 0.000 | 3.402 |
